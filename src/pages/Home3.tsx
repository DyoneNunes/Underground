...
import AdvantagesSection from '../components/Sections/AdvantagesSection2/AdvantagesSection';
import PopularHikesSection from '../components/Sections/PopularHikesSection/PopularHikesSection';
import BlogSection from '../components/Sections/BlogSection3/BlogSection';
import {
    ADVANTAGES_IMAGES,
    HIKES,
    PHOTOS,
